...
<body>
    ...
    <div>
        ...
        <p>Email <asp:TextBox ID="EmailTextBox" runat="server" TextMode="Email"></asp:TextBox></p>
        ...
        <p>Zipcode <asp:TextBox ID="ZipTextBox" runat="server" TextMode="Number"></asp:TextBox></p>
        <p>Home Phone <asp:TextBox ID="HomePhoneTextBox" runat="server" TextMode="Phone"></asp:TextBox></p>
        <p>Work Phone <asp:TextBox ID="WorkPhoneTextBox" runat="server" TextMode="Phone"></asp:TextBox></p>
